# 移植自 mlx-gen 0.37 的 mflux/models/minimax_h3/model/h3_video_vae/h3_video_vae.py（MIT，Filip Strand / AbstractVision）；
...
from comfyui_mlx_gen.h3.model.h3_transformer.h3_attention import H3FeedForward
