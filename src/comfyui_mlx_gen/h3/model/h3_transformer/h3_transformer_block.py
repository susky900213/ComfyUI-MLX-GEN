# 移植自 mlx-gen 0.37 的 mflux/models/minimax_h3/model/h3_transformer/h3_transformer_block.py（MIT，Filip Strand / AbstractVision）；
# 本插件只改导入路径与包名，算法逻辑逐行一致。
import mlx.core as mx
from mlx import nn

from comfyui_mlx_gen.h3.model.h3_transformer.h3_attention import H3Attention, H3FeedForward
from comfyui_mlx_gen.h3.model.h3_transformer.h3_embedding import H3AdaLayerNormModulation
