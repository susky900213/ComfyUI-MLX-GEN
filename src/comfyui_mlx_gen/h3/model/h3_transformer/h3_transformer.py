# 移植自 mlx-gen 0.37 的 mflux/models/minimax_h3/model/h3_transformer/h3_transformer.py（MIT，Filip Strand / AbstractVision）；
...
from comfyui_mlx_gen.h3.model.h3_precision import linear_input_dtype
from comfyui_mlx_gen.h3.model.h3_transformer.h3_embedding import (
    H3AdaLayerNormOut,
    H3RotaryPosEmbed,
    H3TimestepEmbedding,
    H3TimestepProjection,
)
from comfyui_mlx_gen.h3.model.h3_transformer.h3_transformer_block import H3TokenRefiner, H3TransformerBlock
